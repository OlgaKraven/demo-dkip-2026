...
(function(root){
 ...
 function guide(){
  ...
  <section><span class="section-code">01 · НАЧАЛО</span><h3>Выберите один модуль</h3><p>Откройте «Учиться и выполнять» → «Разбор». Выберите модуль и свою базу: MySQL или PostgreSQL. Скачайте исходные материалы. Начните с «Как сделать пошагово».</p></section>
