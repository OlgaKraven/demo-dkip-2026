...
for(const f of ['er-guide.js','er-guide.css','product-tour.js'])write(path.join(out,f),fs.readFileSync(path.join('src',f)));
write(path.join(out,'er-data.js'),'globalThis.ER_GUIDE='+JSON.stringify(buildErGuide())+';\n');
